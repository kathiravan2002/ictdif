...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.ictdif@gmail.com';
    $mail->Password   = 'lhmo fekn oagq udzh'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.ictdif@gmail.com', 'ICTDIF Enquiry');
    $mail->addAddress('info.ictdif@gmail.com', 'ICTDIF Enquiry');
    ...
    $replyMail->Username   = 'info.ictdif@gmail.com';
    $replyMail->Password   = 'lhmo fekn oagq udzh';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.ictdif@gmail.com', 'ICTDIF Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICTDIF 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICTDIF 2025 Team</p>
        </div>
    ';
